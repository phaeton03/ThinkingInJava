...
class Mail {
    ...
    enum MailForward { FAIL, OK1, OK2, OK3, OK4, OK5}
    ...
    public static Mail randomMail() {
        ...
        m.mailForward = Enums.random(MailForward.class);
...
public class PostOffice {
    enum MailHandler {
        ...
        FORWARD_MAIL {
            boolean handle(Mail m) {
                switch (m.mailForward) {
                    case FAIL: return false;
                    default:
                        System.out.println("Forwarding " + m + " to another address");
                        return true;
                }
            }
        },
